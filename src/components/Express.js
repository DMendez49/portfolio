      ...
      <div class="left-column">
        <div class="right-column">
          ...
          <div class='oz'>
            <img 
            alt="build diagram" 
            src="https://www.expresspros.com/uploadedImages/Landing_Pages/Express_Reviews/EEP.PNG?n=5007" 
            width="400" 
            className="img"
            height="200">
            </img>
          ...
          <card>
            <div class="backy">
              ...
              <h3><li>
                Four-clift driver for 3 years
                delevered 6000 lbs of products to different departments developing powdered products for Walmart, Costco, and other distributers around the nation.
          </li></h3>
            </div>
          </card>
        </div>
